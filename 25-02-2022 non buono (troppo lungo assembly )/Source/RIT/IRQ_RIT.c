...
extern volatile uint8_t vett_input[DIM];
extern volatile uint8_t vett_output[DIM];
/******************************************************************************
...
{			
	...
	if((LPC_GPIO1->FIOPIN & (1<<29)) == 0 && status) {		/* Joystick UP */
		/* Joytick UP pressed */
		J_up++;
		switch(J_up){
			case 1:				
	...
	if((LPC_GPIO1->FIOPIN & (1<<26)) == 0 && status) {		/* Joystick DOWN */
		/* Joytick DOWN pressed */
		J_down++;
		switch(J_down){
			case 1:				
				insertValue(TRATTINO);
				break;
			case long_press_count_1:
				// your code here (for long press)
				break;
	...
	if((LPC_GPIO1->FIOPIN & (1<<28)) == 0 && status) {		/* Joystick RIGHT */
		/* Joytick RIGHT pressed */
		J_right++;
		switch(J_right){
			case 1:				
			  insertValue(CAMBIOLETT);
				break;
			case long_press_count_1:
				// your code here (for long press)
				break;
	...
	if((LPC_GPIO1->FIOPIN & (1<<27)) == 0 && status) {		/* Joystick LEFT */
