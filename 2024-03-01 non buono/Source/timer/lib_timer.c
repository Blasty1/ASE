...
/*
	SRImatchRegister specifica come reactare quando si arriva il timer arriva alla threshold 
	BIT da settare Stop/Reset/Interrupt XXX
	XXI=1,
	XRX = 2,
	XRI = 3,
	SXX = 4,
	...
	SRI = 7
*/
uint32_t init_timer ( uint8_t timer_num, uint8_t MatchReg, SRIcombinations SRImatchReg, long long  TimerInterval )
{
  if ( timer_num == 0 )
  {
