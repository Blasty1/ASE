...
extern volatile int8_t current_position;
extern volatile int8_t valueExtracted;
extern volatile uint8_t firstPush;
			...
			switch(down_1){
				case 2:
					if(firstPush == 0)
					{
						...
						init_timer(2,0,XRX,0x23F8EAE900);
						enable_timer(2);
						firstPush=1;
					}else if(firstPush == 1) {
						valueExtracted=(LPC_TIM2->TC & 0b011111111000) >> 3;
						storeValue();
					}
					toRelease_down_1=1;
					break;
