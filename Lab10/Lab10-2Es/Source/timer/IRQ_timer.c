...
extern uint32_t circular_buffer[N]; /* variables defined in the main.c file */
...
{
	circular_buffer[index]=LPC_TIM0->TC;
	index = (index+1) % N;
...
void TIMER2_IRQHandler (void)
{
  ...
  LPC_TIM2->IR = 3;			/* clear interrupt flag */ /* 3 perchè utilizzo tutti e 2 i registri MR0 e MR1 e quindi i loro interrupt vanno messi a 0 */
  return;
}
