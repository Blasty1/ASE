...
uint32_t init_timer ( uint8_t timer_num,uint8_t matchType, uint32_t TimerInterval )
{
  if ( timer_num == 0 )
  {
...
//	<<< end of configuration section >>>   
	...
	else if ( timer_num == 2 )
  {
	...
	LPC_TIM2->MCR = 25;				/* MR0I a 1 e MR1I e MR1R a 1 */
	...
	}else if ( timer_num == 3 )
  {
	...
	LPC_TIM3->MCR = 25;				/* MR0I a 1 e MR1I e MR1R a 1 */
