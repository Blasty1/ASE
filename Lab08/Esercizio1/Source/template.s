...
SVC_Handler     PROC
				...
				;entri e subito lavori con l'msp
				STMFD SP!, {R0-R12, LR}
				CMP LR, #0xFFFFFFF1
				MRS	R1, psp	
				...
				BIC R0, #0xFF000000
				LSR R0, #16 ;in r0 ho l'input sostanzialmente
				; your code here
				
				; 10101 --> 10101000000
				
				MOV R2,#8 ;dim Immediate in SVC 
				MOV R3,#1
				MOV R5,#0 ;result
				MOV R6,#23 ;index
