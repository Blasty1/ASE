...
extern volatile livelloSoddisfazione statsPercentuali;
extern volatile livelloSoddisfazione stats;
extern volatile int total_number_of_clients;
...
{			
	...
	if((LPC_GPIO1->FIOPIN & (1<<28)) == 0) {		/* Joystick RIGHT */
		...
		switch(J_right){
			case 1:				
			  total_number_of_clients = stat_satisfaction(stats.S, stats.N, stats.I,(char *) &statsPercentuali.S,(char *) &statsPercentuali.N, (char *)&statsPercentuali.I);
	...
	if((LPC_GPIO1->FIOPIN & (1<<27)) == 0) {		/* Joystick LEFT */
		...
		switch(J_left){
			case 1:				
			 ...
			 statsPercentuali.I=0;
				statsPercentuali.N=0;
				statsPercentuali.S=0;
				break;
			case long_press_count_1:
				// your code here (for long press)
				break;
